<?php
    ...
    <section class='section-agents section-t8 contentdisciplinas'>
        ...
        <div class='col-md-9 columnas9'>
          <img id='imgFondo' src='../img/disciplinas/1572999143_60851608_1879509468815297_4740735723949260800_n.jpg' width='100%' height='100%'>
        </div>
        <div class='col-md-3 colorFondo'>
        <br>        
          <?php 
               if(file_exists('../videos/ballet.php')){ ?>
                <a href='../videos/ballet.php' class='btn btn-success'>Videos</a>
               <?php }
            ?>
