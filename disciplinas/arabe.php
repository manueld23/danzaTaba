<?php
    ...
    <section class='section-agents section-t8 contentdisciplinas'>
        ...
        <div class='col-md-9 columnas9'>
          <img id='imgFondo' src='../img/disciplinas/1579732496_61020665_1879510282148549_5854494943657066496_n.jpg' width='100%' height='100%'>
        </div>
        <div class='col-md-3 colorFondo'>
        <br>        
          <?php 
               if(file_exists('../videos/arabe.php')){ ?>
                <a href='../videos/arabe.php' class='btn btn-success'>Videos</a>
               <?php }
            ?>
            <button class='btn btn-info'>Informacion</button> <br><br>
          <span>
            Descripción:
Danza Árabe, Danza del Vientre, Danza Oriental, Bellydance; es conocida de distintas maneras, pero cualquiera que sea la manera en la que la conozcas, hace referencia a esta danza milenaria, que además de ser un baile hermoso, tiene diversos beneficios para las bailarinas que la practi
          </span>
        </div>
